...
car::scatterplot(Asales1 ~ Aadv2, legend.columns=T)
?car::scatterplot
plot(Aadv2, Asales1)
abline(lm(Asales1 ~ Aadv2))
...
vcd::mosaic( ~ Class + Sex + Age + Survived, data = Titanic, shade=T, legend=T)
names(Titanic)
...
boxplot(df1$Asales1 ~ df1$Acoy1, varwidth=T, col=2:4)
boxplot(df1$Asales1 ~ df1$Acoy1+df1$Aloc1, varwidth=T, col=2:3)
