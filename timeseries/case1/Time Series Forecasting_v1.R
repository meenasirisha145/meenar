...
require(forecast)
adf.test(LDTSdata,alternative="s")
...
ARIMAFit1=arima((log10(TSdata)),c(1,1,1))
...
ARIMAFit2=arima((log10(TSdata)),c(0,1,1))


summary(ARIMAFit2)
#Running the ARIMA model-R, gives the best model fit 
require(forecast)
ARIMAFit3=auto.arima(log10(TSdata),approximation=TRUE,trace=TRUE)
?auto.arima
?arima
summary(ARIMAFit3)
ARIMAFit1$residuals
#Predicting the future values
pred=predict(ARIMAFit3,n.ahead=36)
pred
